...
const adminToken = await AdminToken.find({})
const originlaToken = await OriginalToken.find({})
...
const updatedAdminToken = await AdminToken.updateMany({adminToken},{                    
    $set: req.body
}, {new: true, runValidators: true});

const updatedOriginalToken = await OriginalToken.updateMany({originlaToken},{                    
    $set: req.body
}, {new: true, runValidators: true});
